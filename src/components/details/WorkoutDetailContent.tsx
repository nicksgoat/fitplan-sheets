...
import { Clock, Heart, ChevronDown, AlertTriangle, ArrowLeft } from 'lucide-react';
...
const WorkoutDetailContent: React.FC<WorkoutDetailContentProps> = ({ item, workoutData }) => {
    ...
    <div className="container max-w-4xl mx-auto py-6 px-4">
      ...
      <div className="bg-dark-200 border border-dark-300 rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="p-4 border-t border-gray-800 flex gap-3">
          ...
          <Button className="flex-1 bg-fitbloom-purple hover:bg-fitbloom-purple/90" onClick={() => navigate('/sheets')}>
            Start Workout
          </Button>
        </div>
      </div>
