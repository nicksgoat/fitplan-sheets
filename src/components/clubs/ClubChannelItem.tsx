...
import { ClubChannel } from '@/types/club';

interface ClubChannelItemProps {
  channel: ClubChannel;
  onClick: (channel: ClubChannel) => void;
  isActive?: boolean;
}

const ClubChannelItem = ({ channel, onClick, isActive }: ClubChannelItemProps) => {
...
export default ClubChannelItem;
