...
import { Home, Search, FolderHeart, ClipboardList, Users, Calendar, ChevronLeft, ChevronRight, Settings, Dumbbell, Book, Trophy, UserCircle, LineChart, PlusCircle, FileText } from 'lucide-react';
...
const Sidebar = ({
  ...
  return (
    <aside className={cn("relative h-full bg-gray-900 flex flex-col border-r border-gray-800 transition-all duration-300", collapsed ? "w-16" : "w-64")}>
