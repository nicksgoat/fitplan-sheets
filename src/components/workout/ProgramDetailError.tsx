    ...
    <div className="container max-w-4xl mx-auto p-4">
      ...
      <Card className="bg-dark-200 border-dark-300 text-center py-8">
        <CardContent className="flex flex-col items-center justify-center">
          <h2 className="text-2xl font-semibold mb-2">Program Not Found</h2>
          <p className="text-gray-400 mb-6 max-w-md">
            {formatErrorMessage(error) || "The program you're looking for doesn't exist or has been removed."}
          </p>
